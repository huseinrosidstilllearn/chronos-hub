...
// Environment variable support for Vite & fallback dynamic assembly
const fallbackApiKey = ["AIzaSy", "DvObGbBD4WRHURZwWtHddezW5FZy_Ig4M"].join("");

export const DEFAULT_FIREBASE_CONFIG = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY || fallbackApiKey,
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || "chronos-hub-by-huseinrosid.firebaseapp.com",
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || "chronos-hub-by-huseinrosid",
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "chronos-hub-by-huseinrosid.firebasestorage.app",
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || "1010580527327",
  appId: import.meta.env.VITE_FIREBASE_APP_ID || "1:1010580527327:android:f740808390479e19ec716a",
  databaseURL: import.meta.env.VITE_FIREBASE_DATABASE_URL || "https://chronos-hub-by-huseinrosid-default-rtdb.asia-southeast1.firebasedatabase.app"
};
